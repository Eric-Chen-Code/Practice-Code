...
// This is a module that provides a Symbol Table ADT
// that assigns int IDs to strings, so they can be used as an integers

// NOTE: all symbol_table parameters must be valid (not NULL)
