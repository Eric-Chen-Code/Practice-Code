...
// This is a module that provides a priority queue ADT
// where the items are strings and the priorities are ints

// NOTE: all pri_queue parameters must be valid (non-null) pri_queues
...
//       for PRI-QUEUE-C are surrounded by {{double curly brackets}}
